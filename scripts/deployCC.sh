...
packageChaincode
infoln "Installing chaincode on peer1.org1.example.com..."
installChaincode org1.example.com peer1.org1.example.com 7051

queryInstalled org1.example.com peer1.org1.example.com 7051

infoln "Installing chaincode on peer2.org1.example.com..."
installChaincode org1.example.com peer2.org1.example.com 7151

queryInstalled org1.example.com peer2.org1.example.com 7151

infoln "Installing chaincode on peer3.org1.example.com..."
installChaincode org1.example.com peer3.org1.example.com 7251

queryInstalled org1.example.com peer3.org1.example.com 7251

approveForMyOrg org1.example.com peer1.org1.example.com 7051

infoln "Installing chaincode on peer1.org2.example.com..."
installChaincode org2.example.com peer1.org2.example.com 9051

queryInstalled org2.example.com peer1.org2.example.com 9051

infoln "Installing chaincode on peer2.org2.example.com..."
installChaincode org2.example.com peer2.org2.example.com 9151

queryInstalled org2.example.com peer2.org2.example.com 9151

infoln "Installing chaincode on peer3.org2.example.com..."
installChaincode org2.example.com peer3.org2.example.com 9251

queryInstalled org2.example.com peer3.org2.example.com 9251

approveForMyOrg org2.example.com peer1.org2.example.com 9051

commitChaincodeDefinition org1.example.com peer1.org1.example.com 7051 org2.example.com peer1.org2.example.com 9051 

queryCommitted org1.example.com peer1.org1.example.com 7051

queryCommitted org2.example.com peer1.org2.example.com 9051

if [ "$CC_INIT_FCN" = "NA" ]; then
  infoln "Chaincode initialization is not required"
else
  chaincodeInvokeInit org1.example.com peer1.org1.example.com 7051 org2.example.com peer1.org2.example.com 9051 
fi
