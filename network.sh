...
function createOrgs() {
  ...
  while :
    ...
    createorg2
    infoln "Creating orderOrg Identities"
    createorderOrg
  fi
...
function networkDown() {
  ...
  if [ "$MODE" != "restart" ]; then
    ...
    docker run --rm -v $(pwd):/data busybox sh -c 'cd /data && rm -rf organizations/fabric-ca/orderOrg/msp organizations/fabric-ca/orderOrg/tls-cert.pem organizations/fabric-ca/orderOrg/ca-cert.pem organizations/fabric-ca/orderOrg/IssuerPublicKey organizations/fabric-ca/orderOrg/IssuerRevocationPublicKey organizations/fabric-ca/orderOrg/fabric-ca-server.db'
